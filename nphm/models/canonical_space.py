...
class NPHM(MessagePassing):
    propagate_type = {
        ...
        'color_feats':      Tuple[Tensor, Tensor],
        'glob_feats':       Tuple[Tensor, Tensor],
        'glob_feats_color': Tuple[Tensor, Tensor],  # if you really need it
        'anchor_idx':       Tensor,
        'is_symm':          Tensor,
        'pos':              Tuple[Tensor, Tensor],
        'debug_region':     bool,
        'skip_color':       bool,                  # if you really need it
    }
